...
def get_tokenizer(lm='bert'):
    ...
    """
    tokenizer = None
    path=os.path.join(os.getcwd(),'core','entity_resolution','CollaborER', '../../lm_models')
    if lm == 'bert':
        from transformers import BertTokenizer
        tokenizer = BertTokenizer.from_pretrained(os.path.join(path,'bert-base-uncased'))
    elif lm == 'distilbert':
        ...
        tokenizer = RobertaTokenizer.from_pretrained(os.path.join(path,'roberta-base'))
    elif lm == 'xlnet':
