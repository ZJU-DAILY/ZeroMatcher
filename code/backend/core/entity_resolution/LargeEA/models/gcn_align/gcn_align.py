...
from core.entity_resolution.LargeEA.models.utils import *
from core.entity_resolution.LargeEA.models.gcn_align.utils import *
from core.entity_resolution.LargeEA.models.gcn_align.metrics import *
from core.entity_resolution.LargeEA.models.gcn_align.models import GCN_Align
...
class GCNAlignWrapper:
    ...
    def get_curr_embeddings(self, device=None):
        import torch
        from core.entity_resolution.LargeEA.utils import apply
