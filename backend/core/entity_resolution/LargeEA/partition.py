...
from core.entity_resolution.LargeEA.dataset import EAData, LargeScaleEAData
from random import sample
import numpy as np
from core.entity_resolution.LargeEA.dto import *
from collections import defaultdict
from tqdm import tqdm, trange
from core.entity_resolution.LargeEA.EAKit import AlignmentData, Experiment
...
class Partition:
    ...
    def partition(self, src=0, src_k=30, trg_k=125, share_triplets=True):
        ...
        print(share_triplets,len(src_triplets))
